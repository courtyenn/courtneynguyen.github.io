...
//            forest2Room.AddEnemy(test, 2, 2);
            ...
            **/       
             var ce1_mapArray =  //define a new array for every level
                   [['O','O','O','O','O','O','X','X','X','X','O','O','O','O','O'],
                    ['O','X','X','X','X','X','X','EH','X','X','X','X','X','G','O'],
                    ['O','G','G','X','X','X','X','X','X','X','X','X','G','G','O'],
                    ['O','G','G','O','X','X','X','X','X','X','X','X','X','G','O'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','O'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','O'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','O'],
                    ['O','X','X','X','X','EM','X','X','X','EM','X','X','X','X','O'],
                    ['O','X','X','O','O','X','X','X','X','X','X','X','X','X','O'],
                    ['O','X','X','X','O','X','X','X','X','X','X','X','X','O','O'],
       ...
       var cave_mapArray =  //define a new array for every level
                   [['O','O','O','O','O','O','O','O','O','O','O','O','O','O','O'],
                    ['O','X','G','G','G','G','G','X','G','G','G','X','G','G','O'],
                    ['o','X','X','X','X','G','G','G','G','G','X','X','G','G','O'],
                    ['O','X','X','G','EH','G','EM','EH','G','G','X','X','X','X','X'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','X'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','X'],
                    ['O','X','X','X','X','X','G','G','X','X','X','X','X','X','X'],
                    ['O','EH','X','X','X','G','G','G','G','X','X','X','EH','X','X'],
                    ['O','G','G','X','X','X','X','X','X','X','X','X','X','X','X'],
                    ['O','G','G','X','X','X','EH','X','X','X','X','X','X','X','X'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','X'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','G','O'],
                    ['O','o','O','X','X','X','X','X','X','X','EE','X','X','G','O'],
                    ['O','R','o','G','X','X','X','R','B','X','X','X','G','G','O'],
                    ['O','O','O','O','O','X','X','X','X','X','O','O','O','O','O']];
//            
...
//            var C1_rock = queue.getResult("C1_rock"); 
       ...
       var lava_mapArray =  //define a new array for every level
                   [['O','O','O','O','O','X','X','X','X','X','O','O','O','O','O'],
                    ['O','X','X','W','EH','X','X','X','X','X','X','X','EH','X','O'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','O'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','O'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','O'],
                    ...
                    ['x','X','X','X','X','x','X','X','X','x','X','X','X','X','x'],
                    ['x','x','x','x','x','x','X','X','X','x','x','x','x','x','x'],
                    ['O','X','X','X','EH','X','X','W','X','X','X','X','EH','X','O'],
                    ['O','X','X','X','X','X','X','X','X','X','X','X','X','X','O'],
